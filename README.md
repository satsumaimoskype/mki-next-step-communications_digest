# Add
Passportの認証の追加の外部の参考サイト
Expressのユーザー認証をPassportで行う(Markdown next step communications)
passport/express-3.x-http-digest-example
express3をexpress4に修正して動かした。
$ curl -v --user jack:secret --digest http://127.0.0.1:3000/ => OK
http://localhost:3000/ =>OK
https://github.com/passport/express-3.x-http-digest-example
